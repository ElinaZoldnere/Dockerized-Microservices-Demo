...
CREATE TABLE generated_proposal_ack (
    id BIGINT NOT NULL AUTO_INCREMENT,
    uuid VARCHAR(255) NOT NULL,
...
DROP INDEX ix_agreements_uuid;
ALTER TABLE agreements ADD CONSTRAINT uq_agreements_uuid UNIQUE (uuid);

DROP INDEX ix_exported_agreements_uuid;
ALTER TABLE exported_agreements ALTER COLUMN uuid SET DATA TYPE VARCHAR(36);
ALTER TABLE exported_agreements
ADD CONSTRAINT uq_exported_agreements_uuid UNIQUE (uuid);
ALTER TABLE exported_agreements
ADD CONSTRAINT fk_exported_agreements_uuid FOREIGN KEY (uuid) REFERENCES agreements(uuid);

ALTER TABLE generated_proposal_ack ALTER COLUMN uuid SET DATA TYPE VARCHAR(36);
ALTER TABLE generated_proposal_ack
ADD CONSTRAINT fk_generated_proposal_ack_uuid FOREIGN KEY (uuid) REFERENCES agreements(uuid);
