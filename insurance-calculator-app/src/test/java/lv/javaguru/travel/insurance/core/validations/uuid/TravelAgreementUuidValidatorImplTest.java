...
class TravelAgreementUuidValidatorImplTest {
    ...
    void validateShouldReturnErrorWhenUuidIsNullOrBlank(String testName, String uuid) {
    ...
    @Test
    void validateShouldReturnErrorWhenUuidDoesNotExistInRepository() {
        String uuid = "INVALID";
    ...
    @Test
    void validateShouldReturnEmptyListWhenUuidExistsInRepository() {
