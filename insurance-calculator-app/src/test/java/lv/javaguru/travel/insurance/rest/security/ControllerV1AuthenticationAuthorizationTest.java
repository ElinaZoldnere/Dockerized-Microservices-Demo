...
class ControllerV1AuthenticationAuthorizationTest {
    ...
    void restControllerV1ShouldReturn200ForValidUserCredentials(String testName, String username, String password)
            throws Exception {
    ...
    void restControllerV1ShouldReturn401ForWrongUserCredentials(String testName, String username, String password)
            throws Exception {
        String requestJsonString = setUpRequestDataMock();
        String basicAuthHeader = "Basic " + Base64.getEncoder().encodeToString((username + ":" + password).getBytes());
    ...
    @Test
    void restControllerV1ShouldReturn401ForIncorrectHeader() throws Exception {
        String requestJsonString = setUpRequestDataMock();
    ...
    @Test
    void restControllerV1ShouldReturn401ForNoCredentials() throws Exception {
        String requestJsonString = setUpRequestDataMock();
