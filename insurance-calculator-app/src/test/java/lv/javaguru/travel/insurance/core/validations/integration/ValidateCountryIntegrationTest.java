...
class ValidateCountryIntegrationTest {
    ...
    @Test
    void validateShouldReturnErrorWhenCountryIsNotValid() {
        ...
        assertThat(result)
                ...
                .containsExactly(
                        Assertions.tuple("ERROR_CODE_92", "Country value INVALID is not supported!"));
    }

    @Test
    void validateShouldReturnErrorWhenCountryIsNull() {
        PersonDTO person = PersonDTOTestBuilder.createPerson()
                .withPersonFirstName("Jānis")
                .withPersonLastName("Bērziņš")
                .withPersonalCode("123456-12345")
        ...
        assertThat(result)
                ...
                .extracting("errorCode", "description")
                .containsExactly(
                        Assertions.tuple("ERROR_CODE_6", "Field country is empty!"));
    }
