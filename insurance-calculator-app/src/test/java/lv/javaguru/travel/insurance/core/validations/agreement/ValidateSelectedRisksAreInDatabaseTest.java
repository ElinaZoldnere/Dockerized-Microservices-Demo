...
class ValidateSelectedRisksAreInDatabaseTest {
    ...
    public void validateListShouldReturnCorrectResponseWhenSelectedRisksAreNotSupported(
    ...
    @Test
    void validateListShouldNotReturnErrorWhenSelectedRisksAreInDatabase() {
        AgreementDTO agreement = AgreementDTOTestBuilder.createAgreement()
